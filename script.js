...
mode.addEventListener("click", () => {
    ...
    if(moon) {
    mode.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" id="sun" width="30" height="17" fill="currentColor" class="bi bi-brightness-high" viewBox="0 0 16 16">
    ...
    document.documentElement.setAttribute("data-theme", "light")
        ...
        mode.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" id="moon" width="30" height="17" fill="currentColor" class="bi bi-moon" viewBox="0 0 16 16">
